...
void pcodevhw(){ // begin 
 ...
 s[3] = 0;
    ...
    code[_i].f = LIT; code[_i].l = 0; code[_i++].a =  5;
    ...
    code[_i].f = OPR; code[_i].l = 0; code[_i++].a =  8;
    code[_i].f = JPC; code[_i].l = 0; code[_i++].a = 24;

    code[_i].f = LOD; code[_i].l = 0; code[_i++].a =  3;
    code[_i].f = LIT; code[_i].l = 0; code[_i++].a =  1;
    code[_i].f = OPR; code[_i].l = 0; code[_i++].a =  3;
    code[_i].f = STO; code[_i].l = 0; code[_i++].a =  8;
    code[_i].f = CAL; code[_i].l = 0; code[_i++].a =  9;
    ...
    code[_i].f = JMP; code[_i].l = 0; code[_i++].a = 26;
