...
void pcodevhw(){ // begin 
 ...
 s[3] = 0;
    ...
    int _i = 0;
    code[_i].f = INT; code[_i].l = 0; code[_i++].a = 4;
    code[_i].f = CAL; code[_i].l = 0; code[_i++].a = 5; 
    ...
    code[_i].f = INT; code[_i].l = 0; code[_i++].a = 8; 
    code[_i].f = LIT; code[_i].l = 0; code[_i++].a = 0; 
    code[_i].f = STO; code[_i].l = 0; code[_i++].a = 3;
    ...
    code[_i].f = LIT; code[_i].l = 0; code[_i++].a = 0; 
    code[_i].f = STO; code[_i].l = 0; code[_i++].a = 6; 

    code[_i].f = LIT; code[_i].l = 0; code[_i++].a = 4; // fib(4)

    code[_i].f = STO; code[_i].l = 0; code[_i++].a = 7; 
    ...
    code[_i].f = LOD; code[_i].l = 0; code[_i++].a = 4; 
    code[_i].f = STO; code[_i].l = 0; code[_i++].a = 3; 
    code[_i].f = LOD; code[_i].l = 0; code[_i++].a = 6; 
    code[_i].f = STO; code[_i].l = 0; code[_i++].a = 4; 
    code[_i].f = LOD; code[_i].l = 0; code[_i++].a = 5; 
    code[_i].f = LOD; code[_i].l = 0; code[_i++].a = 7; 
    code[_i].f = OPR; code[_i].l = 0; code[_i++].a = 11;
    code[_i].f = JPC; code[_i].l = 0; code[_i++].a = 33;
    code[_i].f = LOD; code[_i].l = 0; code[_i++].a = 5; 
    code[_i].f = LIT; code[_i].l = 0; code[_i++].a = 1; 
    code[_i].f = OPR; code[_i].l = 0; code[_i++].a = 2; 
    code[_i].f = STO; code[_i].l = 0; code[_i++].a = 5; 
    code[_i].f = JMP; code[_i].l = 0; code[_i++].a = 16;
    code[_i].f = OPR; code[_i].l = 0; code[_i++].a = 0;
